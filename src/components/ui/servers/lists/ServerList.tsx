    ...
    return (
        <div class="flex flex-col items-center h-full">
            <For each={SERVERS}>
                {(server: Server) => (
                    <div
                        class="p-2 max-w-fit cursor-pointer"
                        onClick={() => {
                    ...
                    >
                        {server.icon ? (
                            ...
                            <div class="flex bg-slate-300 dark:bg-slate-600 text-gray-700 dark:text-gray-200 text-center items-center justify-center rounded-full w-[42px] h-[42px]">
